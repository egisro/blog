...
<body>
    <header>
        ...
        {{--Bootstrap 4 navbar--}}
        <div class="container">
            <nav class="navbar navbar-toggleable-md fixed-top navbar-inverse bg-success bg-faded">
                <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <a class="navbar-brand" href="{{ url('/forum') }}"><i class="fa fa-edge" aria-hidden="true"></i> <span class="logo font-face">Forum</span></a>
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('blog') ? "active" : "" }}" href="/blog">Blog <span class="sr-only"></span></a>
                        </li>
